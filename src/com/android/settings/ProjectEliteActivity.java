...
public class ProjectEliteActivity extends AlertActivity 
    ...
    private static final String PROPERTY_LPROJECTELITE_URL = "ro.url.projectelite";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String userSafetylegalUrl = SystemProperties.get(PROPERTY_LPROJECTELITE_URL);
        ...
        mWebView.setWebViewClient(new WebViewClient() {
            ...
            public void onPageFinished(WebView view, String url) {
                ...
                mAlert.setTitle(getString(R.string.settings_projectelite_activity_title));
            }
        ...
        p.mTitle = getString(R.string.settings_projectelite_activity_loading);
        p.mView = mWebView;
    ...
    private void showErrorAndFinish(String url) {
        new AlertDialog.Builder(this)
                .setMessage(getResources()
                        .getString(R.string.settings_projectelite_activity_unreachable, url))
